...
* (.pdf e .html) di tutte le informazioni relative agli insegnamenti asseganti ad un 
* dato docente del Dipartimento di Informatica.
* I file relativi ai dati verranno salvati all'interno del computer ed in particolare in
* "c:".
*/
public class A_ReportisticaInsegnamenti2 extends javax.swing.JFrame implements ActionListener, ListSelectionListener {
	...
	public A_ReportisticaInsegnamenti z2;
	...
	public A_ReportisticaInsegnamenti2(A_ReportisticaInsegnamenti z) {
		super();
		z2=z;
		initGUI();
	}
			...
			this.setTitle("REPORTISTICA INSEGNAMENTI");
			{
				...
				getContentPane().add(jPanel1, BorderLayout.CENTER);
				{
					...
					}
					{
						...
						jLabelSottotitolo.setText("Stampa degli insegnamenti con i relativi dati di un docente in formato .html e .pdf ");
				...
				}
				{
					...
					jPanel3.setPreferredSize(new java.awt.Dimension(350, 482));
					...
					try
					{
						...
						query="Select DISTINCT Nome, Cognome from dati_docenti, associa_doc where dati_docenti.Login=associa_doc.Login and dati_docenti.Password=associa_doc.Password";
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equalsIgnoreCase("Stampa .pdf"))
		{
			...
			try
			{
				...
				query="Select * from dati_insegnamento, associa_doc, dati_docenti where dati_insegnamento.Nome_insegn=associa_doc.Nome_insegn and dati_insegnamento.Corso_laurea=associa_doc.Corso_laurea and associa_doc.Login=dati_docenti.Login and associa_doc.Password=dati_docenti.Password and dati_docenti.Nome='"+pNome+"' and dati_docenti.Cognome='"+pCognome+"'";
				...
				ResultSet rs=stmt.executeQuery(query);
					...
					try
					{
						PdfWriter.getInstance(doc, new FileOutputStream("C:/Amm_Dati insegnamenti(ii).pdf"));
					}
					...
					try
					{
						...
						doc.add(new Paragraph(" "));
						doc.add(new Paragraph ("I dati relativi agli insegnamenti associati al docente " +pNome+" "+pCognome+", presenti all'interno del Dipartimento d'informatica, sono:"));
						doc.add(new Paragraph(" "));
					}
		...
		if(e.getActionCommand().equalsIgnoreCase("Stampa .html"))
		{
			...
			try
			{
				...
				ResultSet rs=stmt.executeQuery(query);
					...
					try
					{
						HtmlWriter.getInstance(doc, new FileOutputStream("C:/Amm_Dati insegnamenti(ii).html"));						
					}
					catch(FileNotFoundException e2)
					{
						e2.printStackTrace();
